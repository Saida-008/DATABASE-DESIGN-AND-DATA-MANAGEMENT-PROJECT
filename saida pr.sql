...
-- Analysis 2: How many trips are completed?
SELECT COUNT(*) AS completed_trips
FROM trips
WHERE status = 'completed';

-- Analysis 3: What is the average ticket price by ticket type?
SELECT
    ticket_type,
    AVG(price) AS average_price
FROM tickets
...
-- Analysis 4: Which vehicles have the highest maintenance costs?
SELECT
    v.vehicle_number,
...
-- Analysis 5: Which passengers bought the most tickets?
SELECT
    p.passenger_id,
    p.first_name,
    p.last_name,
